...
import { feedbackTags, TFeedbackContent, TFeedbackRating, TFeedbackTag } from './feedback';
...
export const tMessageSchema = z.object({
  ...
  ratingContent: z
    .object({
      tags: z.array(z.enum([...feedbackTags.thumbsUp, ...feedbackTags.thumbsDown] as const)).optional(),
